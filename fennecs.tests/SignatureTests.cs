...
public class SignatureTests
{
    ...
    {
        var signatureA = new Signature(TypeExpression.Of<int>(Identity.Plain), TypeExpression.Of<string>(Identity.Plain));
        var signatureEqual = new Signature(TypeExpression.Of<int>(Identity.Plain), TypeExpression.Of<string>(Identity.Plain));
        var signatureSubset = new Signature(TypeExpression.Of<int>(Identity.Plain));
        var signatureSuperset = new Signature(TypeExpression.Of<int>(Identity.Plain), TypeExpression.Of<string>(Identity.Plain), TypeExpression.Of<float>(Identity.Plain));
    ...
    {
        var signatureA = new Signature(TypeExpression.Of<int>(Identity.Plain), TypeExpression.Of<string>(Identity.Plain));
        var signatureB = new Signature(TypeExpression.Of<int>(Identity.Plain), TypeExpression.Of<float>(Identity.Plain));
        var signatureC = new Signature(TypeExpression.Of<string>(Identity.Plain), TypeExpression.Of<float>(Identity.Plain));
        var signatureD = new Signature(TypeExpression.Of<int>(Identity.Plain), TypeExpression.Of<string>(Identity.Plain), TypeExpression.Of<float>(Identity.Plain));
        ...
        Assert.Equal(new Signature(TypeExpression.Of<string>(Identity.Plain)), intersect);
        Assert.Equal(new Signature(TypeExpression.Of<float>(Identity.Plain)), symmetricExcept);
        Assert.Equal(new Signature(TypeExpression.Of<string>(Identity.Plain)), except);
    }
    ...
    {
        var signature = new Signature(TypeExpression.Of<int>(Identity.Plain), TypeExpression.Of<string>(Identity.Plain));
    ...
    {
        var signature1 = new Signature(TypeExpression.Of<int>(Identity.Plain), TypeExpression.Of<string>(Identity.Plain));
        var signature2 = new Signature(TypeExpression.Of<int>(Identity.Plain), TypeExpression.Of<float>(Identity.Plain));
