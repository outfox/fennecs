...
public class Match2Tests
{
    ...
    {
        using var query = _world.Query<string, float>(MatchOld.Any, MatchOld.Plain).Compile();
    ...
    {
        using var query = _world.Query<string, float>(MatchOld.Plain, MatchOld.Plain).Compile();
    ...
    {
        using var query = _world.Query<string, float>(MatchOld.Target, MatchOld.Plain).Compile();
    ...
    {
        using var query = _world.Query<string, float>(MatchOld.Entity, MatchOld.Plain).Compile();
    ...
    {
        using var query = _world.Query<string, float>(MatchOld.Object, MatchOld.Plain).Compile();
