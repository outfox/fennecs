...
public static class ExpressionTests
{
    ...
    // The wildcard-equivalence semantics formerly tested via TypeExpression.Expand() are now
    // covered pairwise by MatchBitsTests' truth-table and agreement tests.
