...
public partial class Query : IEnumerable<Entity>, IDisposable
{
    ...
    public ref C Ref<C>(Entity entity, MatchOld match)
    {
    ...
    /// <inheritdoc cref="Ref{C}(fennecs.Entity,MatchOld)"/>
    ...
    public bool Contains<T>(MatchOld match = default)
    {
    ...
    */
    ...
    internal Query()
    {
        ...
        Mask ??= MaskPool.Rent().Has(TypeExpression.Of<Identity>(MatchOld.Plain));
    }
