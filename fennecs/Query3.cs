...
public class Query<C0, C1, C2> : Query<C0, C1> where C2 : notnull where C1 : notnull where C0 : notnull
{
    ...
    public void For<U>(UniformComponentAction<C0, C1, C2, U> action, U uniform)
    {
        using var worldLock = World.Lock();
    ...
    public void Job<U>(UniformComponentAction<C0, C1, C2, U> action, U uniform)
    {
        var chunkSize = Math.Max(1, Count / Concurrency);
    ...
    public void Raw<U>(MemoryUniformAction<C0, C1, C2, U> uniformAction, U uniform)
    {
    ...
    public void Blit(C2 value, Identity target)
    {
        using var worldLock = World.Lock();
    ...
    /// <inheritdoc cref="Blit(C2,fennecs.Identity)"/>
    public void Blit(C2 value) => Blit(value, MatchOld.Plain);
    #endregion
    ...
    public override Query<C0, C1, C2> Warmup()
    {
        ...
        C1 c1 = default!;
        C2 c2 = default!;
        NoOp(ref c0, ref c1, ref c2);
        NoOp(ref c0, ref c1, ref c2, 0);
