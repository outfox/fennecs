...
file class StreamsForExplicitGenerator
{
    ...
    public void Main(ICodegenContext context)
    {
        ...
        context["Streams.For.explicit.g.cs"].Write($"{source}");
    }
    ...
    private static string GenerateFor(bool entity, bool uniform, int width, int bits)
    {
        ...
        return //Language=C#
            $$"""        
                      ...
                      public void ForX{{(uniform ? "<U>(U uniform, " : "(")}}Action<{{ActionParams(width, entity, uniform, pattern)}}> action)
                      {
