...
public partial class World
{
    ...
    {
        return new QueryBuilder<Identity>(this, MatchOld.Any);
    }
    ...
    {
        return new QueryBuilder<C1>(this, MatchOld.Any);
    }


    /// <summary>
    /// Creates a fluent Builder for a query with one output Stream Type.
    /// A <see cref="MatchOld"/> expression can be specified to limit the components matched to Stream Types, for instance:
    /// <see cref="MatchOld.Any"/>, <see cref="MatchOld.Entity"/>, <see cref="MatchOld.Object"/>, <see cref="MatchOld.Plain"/> or <see cref="MatchOld.Target"/>.
    /// </summary>
    /// <remarks>
    ...
    {
        return new QueryBuilder<C1, C2>(this, MatchOld.Any, MatchOld.Any);
    }
    ...
    {
        return new QueryBuilder<C1, C2, C3>(this, MatchOld.Any, MatchOld.Any, MatchOld.Any);
    }
    ...
    {
        return new QueryBuilder<C1, C2, C3, C4>(this, MatchOld.Any, MatchOld.Any, MatchOld.Any, MatchOld.Any);
    }
    ...
    {
        return new QueryBuilder<C1, C2, C3, C4, C5>(this, MatchOld.Any, MatchOld.Any, MatchOld.Any, MatchOld.Any, MatchOld.Any);
    }
