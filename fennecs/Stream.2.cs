...
public record Stream<C0, C1>(Query Query, MatchOld Match0, MatchOld Match1)
    ...
    where C1 : notnull
{
    ...
    /// </summary>
    protected MatchOld Match1 { get; init; } = Match1;
    ...
    public void Blit(C1 value, MatchOld target = default)
    {
        using var worldLock = World.Lock();
