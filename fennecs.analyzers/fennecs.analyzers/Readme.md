...
### fennecs.analyzers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [fennecs.analyzers.Sample.csproj](../fennecs.analyzers.Sample/fennecs.analyzers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### fennecs.analyzers.Tests
