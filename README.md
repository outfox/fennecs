...
> If you need a production-ready ECS *today*, 9 out of 10 🦊 endorse [Friflo.Engine.ECS](https://github.com/friflo/Friflo.Json.Fliox/blob/main/Engine/README.md)👍 and [Flecs.NET](https://github.com/BeanCheeseBurrito/Flecs.NET)👍
