...
> If you want solid production-ready software, 9 out of 10 fennecs endorse [Friflo.Engine.ECS](https://github.com/friflo/Friflo.Json.Fliox/blob/main/Engine/README.md) and [Flecs.NET](https://github.com/BeanCheeseBurrito/Flecs.NET)
